    ...
    <main className="relative min-h-screen overflow-hidden font-sans text-zinc-100 animate-page-in bg-[#050505]">
      ...
      <div className="relative z-10 mx-auto w-full max-w-xl px-4 pt-6 pb-24 sm:px-6 sm:pt-16 sm:pb-12">
        ...
        <div className="refined-card rounded-2xl border border-white/[0.08] overflow-hidden p-4 sm:p-6 shadow-xl">
          ...
          <div className="radar-chart-wrapper mx-auto mt-6 flex min-w-0 max-w-full justify-center px-4 py-4 sm:px-0 sm:py-0">
        ...
        <div className="mt-6 rounded-2xl border border-amber-500/30 bg-amber-500/10 p-4 text-center">
          <a
            ...
            className="inline-flex min-h-11 items-center justify-center rounded-xl bg-gradient-to-r from-amber-600 to-amber-500 px-4 sm:px-6 py-2.5 text-xs sm:text-sm leading-snug text-center font-bold text-white shadow-[0_2px_12px_rgba(217,119,6,0.35)] transition hover:from-amber-500 hover:to-amber-400"
          >
